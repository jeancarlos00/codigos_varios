...
# tamaño de la ventana(modificado de 1020 a 1040)
aplicacion.geometry('1040x630+0+0')
...
# listas de productos
lista_comidas = ['pollo', 'arroz', 'habichuela', 'pezcado', 'platano', 'pizza']
lista_bebidas = ['agua', 'soda', 'mabi', 'jugo', 'chocolate', 'te']
lista_postres = ['helados', 'fruta', 'pastel', 'bizcocho', 'flan', 'dulce']
