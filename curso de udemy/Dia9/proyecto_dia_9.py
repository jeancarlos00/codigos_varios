...
import time  # para medir cuanto duro la ejecucion del programa
import datetime  # para saber la fecha del dia de hoy
from pathlib import Path  # para construir rutas
import math  # para redondear el tiempo de ejecucion del programa

inicio = time.time()

ruta = 'C:\\Users\\Jean Carlos\\Desktop\\Mi_Gran_Directorio'
